...
def build_dashboard_screen(parent: tk.Widget, context: AppContext) -> tk.Widget:
    service = context.registry.get_service("dashboard")
    frame = ttk.Frame(parent, padding=16)

    ttk.Label(frame, text="Dashboard", font=("Segoe UI", 16, "bold")).pack(anchor=tk.W)
